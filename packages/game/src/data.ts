...
export const BOARD: BoardSpace[] = [
  ...
  street(1, 'Armadale', 'brown', 60, 50, [2, 10, 30, 90, 160, 250]),
  { index: 2, name: 'Community Chest', type: 'community-chest' },
  street(3, 'Midland', 'brown', 60, 50, [4, 20, 60, 180, 320, 450]),
  { index: 4, name: 'Income Tax', type: 'tax', amount: 200 },
  railroad(5, 'Fremantle Line'),
  street(6, 'Gosnells', 'light-blue', 100, 50, [6, 30, 90, 270, 400, 550]),
  { index: 7, name: 'Chance', type: 'chance' },
  street(8, 'Balga', 'light-blue', 100, 50, [6, 30, 90, 270, 400, 550]),
  street(9, 'Rockingham', 'light-blue', 120, 50, [8, 40, 100, 300, 450, 600]),
  { index: 10, name: 'Jail / Just Visiting', type: 'jail' },
  street(11, 'Cannington', 'pink', 140, 100, [10, 50, 150, 450, 625, 750]),
  utility(12, 'Electric Company'),
  street(13, 'Maddington', 'pink', 140, 100, [10, 50, 150, 450, 625, 750]),
  street(14, 'Thornlie', 'pink', 160, 100, [12, 60, 180, 500, 700, 900]),
  railroad(15, 'Joondalup Line'),
  street(16, 'Hillarys', 'orange', 180, 100, [14, 70, 200, 550, 750, 950]),
  { index: 17, name: 'Community Chest', type: 'community-chest' },
  street(18, 'Victoria Park', 'orange', 180, 100, [14, 70, 200, 550, 750, 950]),
  street(19, 'Bayswater', 'orange', 200, 100, [16, 80, 220, 600, 800, 1000]),
  { index: 20, name: 'Free Parking', type: 'free-parking' },
  street(21, 'Maylands', 'red', 220, 150, [18, 90, 250, 700, 875, 1050]),
  { index: 22, name: 'Chance', type: 'chance' },
  street(23, 'Mount Hawthorn', 'red', 220, 150, [18, 90, 250, 700, 875, 1050]),
  street(24, 'Scarborough', 'red', 240, 150, [20, 100, 300, 750, 925, 1100]),
  railroad(25, 'Mandurah Line'),
  street(26, 'Mount Lawley', 'yellow', 260, 150, [22, 110, 330, 800, 975, 1150]),
  street(27, 'Subiaco', 'yellow', 260, 150, [22, 110, 330, 800, 975, 1150]),
  utility(28, 'Water Works'),
  street(29, 'Claremont', 'yellow', 280, 150, [24, 120, 360, 850, 1025, 1200]),
  { index: 30, name: 'Go To Jail', type: 'go-to-jail' },
  street(31, 'Applecross', 'green', 300, 200, [26, 130, 390, 900, 1100, 1275]),
  street(32, 'Cottesloe', 'green', 300, 200, [26, 130, 390, 900, 1100, 1275]),
  { index: 33, name: 'Community Chest', type: 'community-chest' },
  street(34, 'City Beach', 'green', 320, 200, [28, 150, 450, 1000, 1200, 1400]),
  railroad(35, 'Airport Line'),
  { index: 36, name: 'Chance', type: 'chance' },
  street(37, 'Dalkeith', 'dark-blue', 350, 200, [35, 175, 500, 1100, 1300, 1500]),
  { index: 38, name: 'Luxury Tax', type: 'tax', amount: 100 },
  street(39, 'Peppermint Grove', 'dark-blue', 400, 200, [50, 200, 600, 1400, 1700, 2000])
];
...
export const CHANCE_CARDS: GameCard[] = [
  card('ch-boardwalk', 'chance', 'Peppermint Grove awaits', 'Advance to Peppermint Grove.', { type: 'move-to', index: 39, collectGo: false }),
  card('ch-go', 'chance', 'Start fresh', 'Advance to GO and collect $200.', { type: 'move-to', index: 0, collectGo: true }),
  card('ch-illinois', 'chance', 'Scarborough', 'Advance to Scarborough. Collect $200 if you pass GO.', { type: 'move-to', index: 24, collectGo: true }),
  card('ch-charles', 'chance', 'Cannington', 'Advance to Cannington. Collect $200 if you pass GO.', { type: 'move-to', index: 11, collectGo: true }),
  card('ch-rail-1', 'chance', 'Catch the train', 'Advance to the nearest train line. Owned rent is doubled.', { type: 'move-nearest', kind: 'railroad', rentMultiplier: 2 }),
  card('ch-rail-2', 'chance', 'Express service', 'Advance to the nearest train line. Owned rent is doubled.', { type: 'move-nearest', kind: 'railroad', rentMultiplier: 2 }),
  ...
  card('ch-reading', 'chance', 'Fremantle Line', 'Take a trip to the Fremantle Line. Collect $200 if you pass GO.', { type: 'move-to', index: 5, collectGo: true }),
